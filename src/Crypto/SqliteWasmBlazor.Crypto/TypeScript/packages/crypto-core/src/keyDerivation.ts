 ...
 */
export function deriveX25519KeyPair(seed: Uint8Array): KeyPair {
 ...
 * Caller must clearBytes(result.privateKey) when done.
 */
export function deriveEd25519KeyPair(seed: Uint8Array): KeyPair {
 ...
 */
export function deriveDualKeyPair(seed: Uint8Array): DualKeyPairFull {
